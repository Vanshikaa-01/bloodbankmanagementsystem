...
public class AddRecipientUI {
    ...
    public VBox getView() {
        ...
        Label heading = new Label("➕ Add New Recipient");
        heading.setFont(Font.font("System", FontWeight.BOLD, 24));
        heading.setTextFill(Color.WHITE);

        TextField tfId = styledField("Recipient ID");
        ...
        Button btnSave = new Button("💾  Save Recipient");
        ...
        btnSave.setOnAction(e -> {
            try (Connection conn = DatabaseConnection.getConnection();
                ...
                ps.setInt(6, Integer.parseInt(tfHospitalId.getText()));

                ps.executeUpdate();

                lblStatus.setTextFill(Color.web("#2ecc71"));
                lblStatus.setText("✅ Recipient added successfully!");
        ...
        vbox.getChildren().addAll(
            heading,
            labeledField("Recipient ID", tfId),
